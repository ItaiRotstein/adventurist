            ...
            <form action="">
                <div className="flex flex-col">
                    ...
                    <div className="flex justify-between mt-2">
                        <select className="text-center w-1/2 p-2 border border-black rounded-3xl" name="activity-type">
                        ...
                        <select className="text-center w-1/2 p-2 border border-black rounded-3xl" name="location">
