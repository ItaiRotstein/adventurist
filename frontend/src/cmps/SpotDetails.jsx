...
export function SpotDetails({ spot }) {
    ...
    return (
        <div className="relative main-layout mt-4">
            <ShareButtons />
            <img src={spot?.img} alt={spot?.name} className="rounded" />
            <ul>
                <li className="py-3 flex justify-between items-center">
                    <h1 className="text-lg font-bold text-center">{spot?.name}</h1>
                ...
                <li className="">
                    <Icon icon="IoInformationCircleOutline" className="inline me-2 w-6 h-6 text-clr4" />
                    <strong>פרטים: </strong>
                    {/* <br/> */}
                    {spot?.details}
                </li>
